...
namespace PaymentGateway.Domain.Tests.DataEncryption
{
    public class DataEncryptorTests
    {
        [Test]
        public void GivenAPrivateKey_WhenEncryptingAString_ThenICanDecryptItBack()
        {
            // Given
            ...
            var decryptedMessage = realDataDecryptor.Decrypt(encryptedMessage);

            // Then

            message.Should().Be(decryptedMessage);
        }
